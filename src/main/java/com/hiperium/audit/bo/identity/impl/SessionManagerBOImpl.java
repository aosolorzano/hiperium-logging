 ...
 *
 */
package com.hiperium.audit.bo.identity.impl;
...
import com.hiperium.audit.bo.identity.SessionManagerBO;
import com.hiperium.audit.service.client.IdentityService;
...
public class SessionManagerBOImpl implements SessionManagerBO {
	...
	public UserSessionVO getUserSessionVO(String userToken) throws InformationException {
		return this.identityService.getUserSessionVO(this.getServiceURI(IdentityRegistryPath.GET_USER_SESSION_VO), userToken);
	}
